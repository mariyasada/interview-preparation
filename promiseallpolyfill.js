...
Promise.all([promise1,promise2,promise3]).then(values=>console.log(values)); //['hello', 42, 'namaste JS']
...
Promise.myAll([promise1,promise2,promise3]).then(values=>console.log(values)).catch(err=>console.log(err));
...
console.log(myAllPromise(promises).then(values=>console.log(values)).catch(err=>console.log(err)));
